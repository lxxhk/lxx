...
if ( ! defined( 'PERFECT_PORTFOLIO_THEME_VERSION' ) && ! defined( 'PERFECT_PORTFOLIO_THEME_NAME' ) && ! defined( 'PERFECT_PORTFOLIO_THEME_TEXTDOMAIN' ) ) {
	$theme_data = wp_get_theme();	
	define( 'PERFECT_PORTFOLIO_THEME_VERSION', $theme_data->get( 'Version' ) );
    define( 'PERFECT_PORTFOLIO_THEME_NAME', $theme_data->get( 'Name' ) );
    define( 'PERFECT_PORTFOLIO_THEME_TEXTDOMAIN', $theme_data->get( 'TextDomain' ) );
}
/**
 * Custom Functions.
 */
